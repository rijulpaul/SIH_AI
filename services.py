...
from schemas import CropRecommendationInput, CropRecommendationOutput, CropYieldInput, CropYieldOutput
...
class CropRecommendationService:
    ...
    def predict(self, input_data: CropRecommendationInput) -> CropRecommendationOutput:
        ...
        return CropRecommendationOutput(
            crop=crop_name,
            message=f"{crop_name} is the best crop for these conditions"
        )
...
class CropYieldService:
    ...
    def predict(self, input_data: CropYieldInput) -> CropYieldOutput:
        ...
        message = f"Yield prediction for {result['Crop']} on {result['Area_ha']} hectares"
